...
public class East extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainview=inflater.inflate(R.layout.fragment_east, container, false);
        ctx=getContext();
        search=(Button)mainview.findViewById(R.id.search);
        POI=(Button)mainview.findViewById(R.id.POI);
        Yi=(Button)mainview.findViewById(R.id.Yi);
        Gi=(Button)mainview.findViewById(R.id.Gi);
        Hua=(Button)mainview.findViewById(R.id.Hua);
        Tai=(Button)mainview.findViewById(R.id.Tai);
        Date currentTime = Calendar.getInstance().getTime();
        SimpleDateFormat s2=new SimpleDateFormat("EEEE", Locale.ENGLISH);
        FirstWeekday=s2.format(currentTime);
        Log.e("currenttime",""+FirstWeekday);
        Yi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(24.754312,121.758378));
            }
        });
        ...
        Gi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(25.131601,121.738378));
            }
        });
        ...
        Hua.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(23.992946,121.601114));
            }
        });
        ...
        Tai.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(22.793711,121.123161));
            }
        });
            ...
            public void onClick(View view) {
                ...
                dialog_list.setTitle("POI").setView(v1).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String result=getUrl(new LatLng(22.793711,121.123161),choice_of_poi,2000);
                        if(firstplace!=null)
                        {
        ...
        b_db.execSQL("CREATE TABLE IF NOT EXISTS "+temp_Btree+" ( _ID INTEGER PRIMARY KEY," +POI_name
                +" TEXT,"+POI_tel+" TEXT,"+POI_lat+" DOUBLE,"+POI_lng+" DOUBLE,"
                +POI_opening_time+" TEXT," +POI_rating+" TEXT,"+POI_address+" TEXT,"+POI_web+" TEXT)");
        String result=getUrl(new LatLng(22.793711,121.123161),"餐廳",2000);
        PlacesTask task = new PlacesTask(0);
        task.execute(result);
    ...
    private class ParserTaskDetail extends AsyncTask<String, Integer, HashMap<String, String>> {
        ...
        protected void onPostExecute(HashMap<String, String> hPlaceDetails) {
            ...
            if(id!="-NA-"&&b_name!="-NA-")
            {
                ...
                POI_schedule_background b_tree_background=new POI_schedule_background(ctx,"East");
    ...
    public static class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
           ...
           /* Picasso.with(ctx).load(photodata.get(position)).resize(4000,3000)
                    .into(holder.IMG);*/
            ...
            holder.itemView.setOnLongClickListener(new View.OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    new AlertDialog.Builder(ctx).setTitle("儲存此地標?").setPositiveButton("ok", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            final String[] tablename={"others","spot","restaurant"};
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                Log.e("first place",""+firstplace.getName());
                Log.e("first place",""+firstplace.getLatLng());
