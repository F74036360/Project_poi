 ...
 */
public class OnePOI_Schedule extends Fragment {
    ...
    public static View POI_scheduleView;
    public OnePOI_Schedule() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        POI_scheduleView=inflater.inflate(R.layout.fragment_one_poi__schedule, container, false);
        ctx=getContext();
        Datebtn=(Button) POI_scheduleView.findViewById(R.id.date);
        POIbtn=(Button)POI_scheduleView.findViewById(R.id.poi);
        OKbtn=(Button)POI_scheduleView.findViewById(R.id.okbtn);
        first=(Button)POI_scheduleView.findViewById(R.id.firstbtn);
        Log.e("into one_poi","one poi!!!");
            ...
            public void onClick(View view) {
                ...
                new DatePickerDialog(getContext(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int month, int day) {
                        ...
                        Log.e("Firstweekday",""+FirstWeekday);
                        Datebtn.setText(""+(month+1)+"-"+day);
                    }
        ...
        OKbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String result=getUrl(firstplace.getLatLng(),choice_of_poi,2000);
                PlacesTask task = new PlacesTask(0);
                task.execute(result);
                }
        });

        return POI_scheduleView;
    }
    ...
    public static void addtoarray()
    {
        ...
        if (c != null) {
            ...
            RecyclerView mList = (RecyclerView) POI_scheduleView.findViewById(R.id.list_view);
    ...
    private class ParserTaskDetail extends AsyncTask<String, Integer, HashMap<String, String>> {
        ...
        protected HashMap<String, String> doInBackground(String... jsonData) {
            ...
            try {
                ...
                /*if(hPlaceDetails.get(FirstWeekday).compareTo("null")!=0&&rating>=3.0)
                {
                    ...
                    Log.e("sep",""+separated[1]);
                    if(separated[1].compareTo("Closed")!=0 &&separated[1].contains("24 小時營業")==false)
                    {
                    ...
                    else if(separated[1].compareTo("Closed")!=0 &&separated[1].contains("24 小時營業")==true)
                    {
                        String photo = "https://maps.googleapis.com/maps/api/place/photo?maxwidth=300&photoreference="
                                + hPlaceDetails.get("ref_photo") + "&key="
                                + "AIzaSyDomABgA1RgXQaE31JakIQi9Cw66nhHGAc";
        ...
        protected void onPostExecute(HashMap<String, String> hPlaceDetails) {
            ...
            if(id!="-NA-"&&b_name!="-NA-")
            {
                ...
                POI_schedule_background b_tree_background=new POI_schedule_background(ctx,"OnePOI_Schedule");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                first.setText(firstplace.getName());
            }
        }
