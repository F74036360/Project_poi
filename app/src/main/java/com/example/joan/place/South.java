...
public class South extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainview=inflater.inflate(R.layout.fragment_south, container, false);
        ctx=getContext();
        search=(Button)mainview.findViewById(R.id.search);
        POI=(Button)mainview.findViewById(R.id.POI);
        Tainan=(Button)mainview.findViewById(R.id.tainan);
        Chia=(Button)mainview.findViewById(R.id.chia);
        Kao=(Button)mainview.findViewById(R.id.kao);
        Ping=(Button)mainview.findViewById(R.id.ping);
        ...
        Tainan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                POITask(new LatLng(22.997183,120.212577));
            }
        });
        ...
        Chia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(23.479119,120.441138));
            }
        });
        ...
        Kao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(22.639761,120.302107));
            }
        });
        ...
        Ping.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(22.668857,120.485963));
            }
        });
            ...
            public void onClick(View view) {
                ...
                dialog_list.setTitle("POI").setView(v1).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String result=getUrl(new LatLng(22.997183,120.212577),choice_of_poi,2000);
                        if(firstplace!=null)
                        {
        ...
        b_db.execSQL("CREATE TABLE IF NOT EXISTS "+temp_Btree+" ( _ID INTEGER PRIMARY KEY," +POI_name
                +" TEXT,"+POI_tel+" TEXT,"+POI_lat+" DOUBLE,"+POI_lng+" DOUBLE,"
                +POI_opening_time+" TEXT," +POI_rating+" TEXT,"+POI_address+" TEXT,"+POI_web+" TEXT)");
        String result=getUrl(new LatLng(22.997183,120.212577),"餐廳",2000);
        PlacesTask task = new PlacesTask(0);
        task.execute(result);
    ...
    private class ParserTaskDetail extends AsyncTask<String, Integer, HashMap<String, String>> {
        ...
        protected HashMap<String, String> doInBackground(String... jsonData) {
            ...
            try {
                ...
                b_opening_time = hPlaceDetails.get("formatted_address");
                b_photo = photo;
        ...
        protected void onPostExecute(HashMap<String, String> hPlaceDetails) {
            ...
            if(id!="-NA-"&&b_name!="-NA-")
            {
                ...
                POI_schedule_background b_tree_background=new POI_schedule_background(ctx,"South");
