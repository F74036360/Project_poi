...
public class North extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mainview=inflater.inflate(R.layout.fragment_north, container, false);
        taipei=(Button)mainview.findViewById(R.id.taipei);
        new_taipei=(Button)mainview.findViewById(R.id.new_taipei);
        shin=(Button)mainview.findViewById(R.id.shin);
        tao=(Button)mainview.findViewById(R.id.tao);
        ctx=getContext();
        ...
        taipei.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                POITask(new LatLng(25.047739,121.517040));
            }
        });

        new_taipei.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(25.014388,121.463527));
            }
        });

        shin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(24.801577,120.971560));
            }
        });
        ...
        tao.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                POITask(new LatLng(24.989206,121.313545));
            }
        });
            ...
            public void onClick(View view) {
                ...
                dialog_list.setTitle("POI").setView(v1).setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        String result=getUrl(new LatLng(25.047739,121.517040),choice_of_poi,2000);
                        if(firstplace!=null)
                        {
        ...
        b_db.execSQL("CREATE TABLE IF NOT EXISTS "+temp_Btree+" ( _ID INTEGER PRIMARY KEY," +POI_name
                +" TEXT,"+POI_tel+" TEXT,"+POI_lat+" DOUBLE,"+POI_lng+" DOUBLE,"
                +POI_opening_time+" TEXT," +POI_rating+" TEXT,"+POI_address+" TEXT,"+POI_web+" TEXT)");
        String result=getUrl(new LatLng(25.047739,121.517040),"餐廳",2000);
        PlacesTask task = new PlacesTask(0);
        task.execute(result);
    ...
    private class ParserTaskDetail extends AsyncTask<String, Integer, HashMap<String, String>> {
        ...
        protected void onPostExecute(HashMap<String, String> hPlaceDetails) {
            ...
            if(id!="-NA-"&&b_name!="-NA-")
            {
                ...
                POI_schedule_background b_tree_background=new POI_schedule_background(ctx,"North");
    ...
    public static class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder>{
        ...
        public void onBindViewHolder(ViewHolder holder, final int position) {
            ...
            /*Picasso.with(ctx).load(photodata.get(position)).resize(4000,1600)
                    .into(holder.IMG);*/
